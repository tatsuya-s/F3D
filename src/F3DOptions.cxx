...
F3DOptions ConfigurationOptions::GetOptionsFromArgs(std::vector<std::string>& inputs)
{
  ...
  try
  {
    ...
    this->DeclareOption(grp2, "base-ior", "", "Base layer IOR (1.0-6.0)", options.IOR, true, "<IOR>");
    this->DeclareOption(grp2, "coat-strength", "", "Coat strength coefficient (0.0-1.0)", options.CoatStrength, true, "<coatStrength>");
    this->DeclareOption(grp2, "coat-ior", "", "Coat IOR (1.0-6.0)", options.CoatIOR, true, "<CoatIOR>");
    this->DeclareOption(grp2, "coat-roughness", "", "Coat roughness coefficient (0.0-1.0)", options.CoatRoughness, true, "<coatRoughness>");
    this->DeclareOption(grp2, "coat-color", "", "Coat color", options.CoatColor, true, "<R,G,B>");
    this->DeclareOption(grp2, "coat-thickness", "", "Coat thickness, affects the amount of color attenuation.", options.CoatThickness, true, "<coatThickness>");
    ...
    this->DeclareOption(grp2, "texture-coat-normal", "", "Path to a texture file that sets the coat normal map", options.CoatNormalTex, true, "<file path>");
    this->DeclareOption(grp2, "coat-normal-scale", "", "Coat normal scale affects the strength of the normal deviation from the coat normal texture", options.CoatNormalScale, true, "<coatNormalScale>");
